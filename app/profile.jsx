    ...
    return (
        ...
        <ScrollView>
            <View style={styles.container}>
                <View style={{ flexDirection: 'row', alignItems: 'center', width: '90%', marginHorizontal: 20, marginVertical: 10 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <TouchableOpacity style={styles.buttonQuadrado}>
                        <Ionicons name="scan" color={"red"} size={30} />
                        <Text style={styles.buttonSubTitle}>Encontrar outras cores ou tamanhos</Text>
                    </TouchableOpacity>
                </View>


                <TouchableOpacity style={{ marginTop: 20, marginButtom: 20 }}>
